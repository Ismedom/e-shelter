<x-layouts.dashboard>
    <x-layouts.accommodation :accommodation="$accommodation">
        <div class="max-w-full mx-auto px-4 py-8">
            <x-form.card title="Edit Room Type" description="Update this room type details">
                ...
                <form action="{{ route('rooms.update', [$accommodation, $room]) }}" method="POST" enctype="multipart/form-data" class="space-y-10">
                    ...
                    >
                        <x-form.grid columns="2">
                            <x-form.input 
                                ...
                                required
                                help-text="Enter a unique name for this room type."
                            />
                            <x-form.input 
                                name="room_number" 
                                label="Room Number" 
                                placeholder="Room Number"
                                :value="old('room_number', $room->room_number ?? 'No number assigned')"
                                required
                                help-text="Enter a unique number for this room"
                            />
                    ...
                    >
                        <x-form.grid columns="2">
                            <x-form.input 
                                ...
                                required
                                icon='<svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>'
                                help-text="Set the base price per night before discount."
                            />
                            ...
                            <x-form.select 
                                ...
                                help-text="Choose the currency used for pricing."
                            />
                        </x-form.grid>
                        ...
                        <x-form.grid columns="2">
                            <x-form.input 
                                ...
                                help-text="Optional discount applied to this room type."
                            />
                    ...
                    >
                        <x-form.textarea 
                            ...
                            rows="4"
                            help-text="Add a compelling description to attract guests."
                        />
                    </x-form.section>
                    ...
                    >
                        <div class="space-y-4">
                            @if($room_type->image)
                                <div class="mb-4">
                                    <img src="{{ asset('storage/' . $room_type->image) }}" alt="Current room image" class="h-48 w-full object-cover rounded-lg shadow-sm">
